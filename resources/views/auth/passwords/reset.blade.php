    ...
    <div class="authentication-inner">
        ...
        <div class="card-body">
            ...
            <h4 class="mb-2">{{ __('Reset Password') }} 🔒</h4>
              <p class="mb-4">Dont forget it again Citizens!</p>
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('password.update') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('email') is-invalid @enderror" readonly id="email" value="{{ $email ?? old('email') }}" name="email" placeholder="Enter your email" required />
                    @error('email')
